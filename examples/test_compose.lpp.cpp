...
int main() {
    auto doubleAfterTriple = []( auto __x ) { return double(triple(__x)); };
    auto result1 = doubleAfterTriple(5);
    print("Double after triple of 5:");
    print(result1);
    auto composed = []( auto __x ) { return addTen(triple(double(__x))); };
    auto result2 = composed(5);
