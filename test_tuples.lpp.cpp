...
int main() {
    auto pair = std::make_tuple(1, 2);
    auto triple = std::make_tuple("hello", 42, true);
    auto nested = std::make_tuple(std::make_tuple(1, 2), std::make_tuple(3, 4));
    auto computed = std::make_tuple((2 + 2), (5 * 10), "result");
    print("Tuples created successfully!");
    return 0;
}
